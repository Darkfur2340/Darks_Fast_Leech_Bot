...
async def save_thumb_nail(client, message):
    ...
    if message.reply_to_message is not None:
        ...
        await ismgs.edit(
            "<b>🎆 Custom video / file thumbnail saved (I Guess I M the proest Bot Ever LOL).</b>\n"
...
async def clear_thumb_nail(client, message):
    ...
    if os.path.exists(thumb_image_path):
        ...
        await ismgs.edit("<b>✅ Custom thumbnail cleared successfully(But Why Bro UR Old Thumb was also Cool).</b>")
    else:
        await ismgs.edit("<b>❌ Nothing to clear Bruh dont clear nothing atleast leech using me LOL.</b>")
